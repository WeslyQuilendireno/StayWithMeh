...
namespace StayWithMeh.Controllers
{
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginViewModel model)
        {
            ...
            // The custom access token hook injects "user_role" and "branch_id" into
            // the JWT — decode it once here to build the cookie identity.
            // "role" is reserved by Supabase itself (always "authenticated"),
            // which is why our custom hook uses "user_role" instead.
            ...
            var role = jwt.Claims.FirstOrDefault(c => c.Type == "user_role")?.Value ?? "Guest";
